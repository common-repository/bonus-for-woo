...
if (isset($_POST['bfw_delete_post_history_points'])) {
    BfwHistory::deleteHistoryId(
        sanitize_text_field($_POST['bfw_delete_post_history_points'])
    );
...
?>
    <form>
        <input type="hidden" name="page"
               value="bonus-for-woo/pages/list_history.php">
        <label><?php
        ...
        <a class="button"
           href="/wp-admin/admin.php?page=bonus-for-woo%2Fpages%2Flist_history.php"><?php
...
BfwHistory::getListHistory($date_start, $date_finish);
